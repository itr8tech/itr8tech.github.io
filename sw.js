...
const PRECACHE = [
  ...
  '/src/ui/sync-indicator.js', '/src/ui/theme.js', '/src/ui/theme-guard.js', '/src/ui/inbox-badge.js', '/src/ui/inbox-triage.js', '/src/ui/pathway-diff.js', '/src/ui/import-dialog.js', '/src/ui/download.js', '/src/ui/publish-html.js', '/src/ui/toast.js',
  ...
  // data modules
  '/src/data/canonical.js', '/src/data/capture-outbox.js', '/src/data/coordinator.js', '/src/data/db-worker.js', '/src/data/legacy.js', '/src/data/exchange.js',
