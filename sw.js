...
const CACHE = 'pathcurator-v5';   // bump on precache/strategy changes → activate() purges the old one
const PRECACHE = [
  ...
  '/src/ui/sync-indicator.js', '/src/ui/theme.js', '/src/ui/theme-guard.js', '/src/ui/inbox-badge.js', '/src/ui/inbox-triage.js', '/src/ui/pathway-diff.js', '/src/ui/import-dialog.js', '/src/ui/download.js', '/src/ui/publish-html.js', '/src/ui/publish-feeds.js', '/src/ui/toast.js', '/src/ui/md-editor.js', '/src/ui/ext-bridge.js', '/src/ui/zip.js', '/src/ui/publish-scorm.js', '/src/ui/publish-moodle.js',
